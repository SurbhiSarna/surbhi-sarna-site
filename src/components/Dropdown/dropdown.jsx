...
const Dropdown = (props) => {
  ...
  return (
    <Popover className="relative">
      <Popover.Button className="mt-2 p-0 pb-2 inline-flex items-center font-fraunces text-md font-bold leading-6 text-slate-700 hover:border-purple-700 hover:border-b-2 hover:border-0 hover:rounded-none focus:outline-none">
